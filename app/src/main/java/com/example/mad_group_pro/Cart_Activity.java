...
import com.example.mad_group_pro.VeiwHolder.CartViewHolder;
import com.example.mad_group_pro.data.model.Cart;
                            ...
                            public void onClick(View v)
                            {
                             CharSequence options[] = new CharSequence[]
                                ...
                                builder.setItems(options, new DialogInterface.OnClickListener() {
                                    ...
                                    {
                                        if(i == 0){
                                            Intent intent = new Intent(Cart_Activity.this,Product_details_veiw_Activity.class);
                                                    ...
                                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                        ...
                                                        public void onComplete(@NonNull Task<Void> task) {
                                                            if(task.isSuccessful()){
                                                                Toast.makeText(Cart_Activity.this, "Item removed Successfully",Toast.LENGTH_SHORT).show();
