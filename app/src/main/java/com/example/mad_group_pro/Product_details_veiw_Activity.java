...
import com.example.mad_group_pro.Prevalent.Prevalent;
...
public class Product_details_veiw_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_product_details_veiw_);

        productID = getIntent().getStringExtra("pid");


        addToCartBtn = (Button) findViewById(R.id.addToCart_btn);
                            ...
                            cartListRef.child("Admin View").child(Prevalent.currentOnlineUser.getPhone()).child("Products")
                                    ...
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task)
                                        {
                                            if(task.isSuccessful())
                                            {
                                                Toast.makeText(Product_details_veiw_Activity.this,"Added To Cart List", Toast.LENGTH_SHORT).show();

                                                Intent intent = new Intent(Product_details_veiw_Activity.this, Home_Activity.class);
    ...
    private void gerProductDetails(String productID)
    {
